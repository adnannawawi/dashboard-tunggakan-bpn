            ...
            <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "9px", color: "#334155" }}>
              <thead>
                <tr style={{ backgroundColor: "#f1f5f9", textTransform: "uppercase" }}>
                  <th style={{ padding: "6px 8px", borderBottom: "2px solid #cbd5e1", textAlign: "center", width: "30px" }}>#</th>
                  <th style={{ padding: "6px 8px", borderBottom: "2px solid #cbd5e1", textAlign: "left" }}>Nomor Berkas</th>
                  <th style={{ padding: "6px 8px", borderBottom: "2px solid #cbd5e1", textAlign: "left" }}>Tgl Terdaftar</th>
                  <th style={{ padding: "6px 8px", borderBottom: "2px solid #cbd5e1", textAlign: "left" }}>Jatuh Tempo</th>
                  <th style={{ padding: "6px 8px", borderBottom: "2px solid #cbd5e1", textAlign: "left" }}>Tgl Selesai</th>
                  <th style={{ padding: "6px 8px", borderBottom: "2px solid #cbd5e1", textAlign: "left" }}>Nama Kegiatan</th>
                  <th style={{ padding: "6px 8px", borderBottom: "2px solid #cbd5e1", textAlign: "left" }}>Nama Pemohon</th>
                  <th style={{ padding: "6px 8px", borderBottom: "2px solid #cbd5e1", textAlign: "left" }}>Posisi Terakhir / Petugas</th>
                  <th style={{ padding: "6px 8px", borderBottom: "2px solid #cbd5e1", textAlign: "center" }}>Status</th>
                </tr>
              </thead>
              <tbody>
                {filteredRincian.map((row, idx) => (
                  <tr key={idx} style={{ borderBottom: "1px solid #e2e8f0" }}>
                    ...
                    <td style={{ padding: "5px 8px", fontWeight: "bold" }}>{row.noBerkas}</td>
